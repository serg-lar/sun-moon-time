...
bool TComputings::TMoonDay::operator == (const TComputings::TMoonDay& rv) const
{
    bool result (true);
...
QList<TComputings::TMoonDay> TComputings::moonTimeMoonDays(const double longitude, const double latitude, const double timeZoneOffset,
